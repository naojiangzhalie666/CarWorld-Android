package cn.droidlover.xdroid.views.recyclerView;
...
public class DividerLine extends RecyclerView.ItemDecoration {
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        this.mDivider = DrawableCompat.wrap(ta.getDrawable(0));
        DrawableCompat.setTint(mDivider, ContextCompat.getColor(parent.getContext(), R.color.line_black));
        ta.recycle();
