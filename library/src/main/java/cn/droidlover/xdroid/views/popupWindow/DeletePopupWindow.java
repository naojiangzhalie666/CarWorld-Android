package cn.droidlover.xdroid.views.popupWindow;
...
public class DeletePopupWindow extends PopupWindow {
    ...
    public DeletePopupWindow(Context context, OnClickListener itemsOnClick, int deleteText) {
        ...
        deleteBtn = (Button) mMenuView.findViewById(R.id.deleteBtn);
        if (deleteText != 0) {
            ((Button) mMenuView.findViewById(R.id.deleteBtn)).setText(deleteText);
        }
