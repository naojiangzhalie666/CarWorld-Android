...
import cn.droidlover.xdroid.views.textView.MarqueeText;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mOutPadding = (int) context.getResources().getDimension(R.dimen.x20);
...
//        }
    ...
    public void setTitle(CharSequence title, boolean bold) {
        int index = title.toString().indexOf("\n");
        if (index > 0) {
            setTitle(title.subSequence(0, index), title.subSequence(index + 1, title.length()), LinearLayout.VERTICAL, bold);
        } else {
            index = title.toString().indexOf("\t");
            if (index > 0) {
                setTitle(title.subSequence(0, index), "  " + title.subSequence(index + 1, title.length()), LinearLayout.HORIZONTAL, bold);
            } else {
                if (bold) {
    ...
    private void setTitle(CharSequence title, CharSequence subTitle, int orientation, boolean bold) {
    ...
    public void setTitle(int resId, boolean bold) {
        setTitle(getResources().getString(resId), bold);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        System.out.println("height" + height + ";mStatusBarHeight" + mStatusBarHeight + ";mHeight" + mHeight);
