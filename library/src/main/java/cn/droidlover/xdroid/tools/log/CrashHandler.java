package cn.droidlover.xdroid.tools.log;
...
import cn.droidlover.xdroid.tools.utils.DateUtil;
...
//         if (null != mContext && !AndPermission.hasPermissions(mContext,Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
//             return;
//         }
