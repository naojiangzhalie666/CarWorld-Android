...
import cn.droidlover.xdroid.views.CutscenesProgress;
...
public class NetworkUtil {
    ...
    public static void showCutscenes(boolean cancelable) {
        showCutscenes("", "", cancelable, true);
    }


    public static void showCutscenes(String title, String content) {
        showCutscenes(title, content, false, true, null);
    }
            ...
            if (null != context) {
                if (null == cutscenesProgress) {
                    ...
                    if (cutscenesProgress.isShowing()) {
                        cutscenesProgress.setTitle(title);
