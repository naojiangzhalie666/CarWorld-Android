...
public class CharsetUtil {
     ...
     *         待转换字符串
     */
    public static String UnicodeToGBK(String input) throws UnsupportedEncodingException {
     ...
     *         待转换字符串
     */
    public static String GBKToUnicode(String input) throws UnsupportedEncodingException {
        if (TextUtils.isEmpty(input)) {
            return "";
        } else {
            return new String(input.getBytes("GBK"), "ISO8859_1");
        }
    }
}