...
public class SortComparator implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
        compareCallNum = 0;
//        return compareString(((Brand.ItemsBean) o1).getName(), ((Brand.ItemsBean) o2).getName());
        return compareString(((Brand.ItemsBean) o1).getLetter(), ((Brand.ItemsBean) o2).getLetter());
    }
    ...
    private int compareString(String o1, String o2) {
        ...
        String firstPinyinB;
        try {
            firstPinyinA = PinYinStringHelper.getFirstPingYin(o1).substring(0, 1);
            firstPinyinB = PinYinStringHelper.getFirstPingYin(o2).substring(0, 1);
        }catch (Exception e){
//        }catch (StringIndexOutOfBoundsException e){
            firstPinyinA=o1;
            firstPinyinB=o2;
//            Logger.e("Jinf",e.getMessage());
        }
        if (compareCallNum == 1) {
