...
public class OrderListFragment extends BaseFragment {
    ...
    public static OrderListFragment newInstance(String type, boolean flag) {
        Bundle args = new Bundle();
        args.putString(Constant.KEY_TYPE, type);
        args.putBoolean("waitAssess", flag);
    ...
    private void getOrderStatus() {
        ...
        wait = getArguments().getBoolean("waitAssess");
...
//                .addParams("status", status)
        ...
        NetApi.get(UrlKit.TRANSPORT_ORDER, map, new JsonCallback() {
            ...
            public void onSuccess(String response, int id) {
                ...
                if (home != null && home.getItems() != null && home.getItems().size() > 0) {
