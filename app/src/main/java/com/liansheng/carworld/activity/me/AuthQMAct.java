...
public class AuthQMAct extends BaseActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        storeType = getIntent().getStringExtra(Constant.KEY_TYPE);
        getUserInfo();
    }
                ...
                if (companyBeans != null && companyBeans.size() > 0) {
                    for (int i = 0; i < companyBeans.size(); i++) {
                        ...
                        if (Constant.STORE_TYPE_1.equals(bean.getType())) {
                            ...
                            ivMtZt.setVisibility(View.VISIBLE);
                            if (Constant.ID_STATUS_REJECT.equals(bean.getStatus())) {
                                ...
                                ivMtZt.setImageResource(R.mipmap.ic_auth_bh);
                                ...
                                if (Constant.ID_STATUS_PASSED.equals(bean.getStatus())) {
                                    ...
                                    ivMtZt.setImageResource(R.mipmap.ic_auth_yrz);
                                } else {
                                    ivYyzzZt.setImageResource(R.mipmap.ic_auth_shz);
                                    ivMtZt.setImageResource(R.mipmap.ic_auth_shz);
                                }
                            }
                            break;
                        }
    ...
    @OnClick({R.id.iv_scan, R.id.iv_sfz_zm, R.id.iv_sfz_fm, R.id.iv_yyzz, R.id.iv_mt, R.id.tv_address, R.id.submit})
    ...
    private String getCompanyBean(String companyName) {
        ...
        companyBean.setSecondHandPriority("2".equals(storeType));
        companyBean.setType(Constant.STORE_TYPE_1);
            ...
            if (requestCode == PictureConfig.CHOOSE_REQUEST) {
                ...
                OssServiceUtil.getInstance().asyncPutImage(OtherLogic.getImgUrl(), path, (objectResult, currentPath) -> {
                    ...
                    if (type == 1) {
                        ...
                        mt = currentPath;
                        Glide.with(context).load(UrlKit.getImgUrl(currentPath)).apply(myOptions).into(ivMt);
                    }
                });
