package com.liansheng.carworld.face;
...
public class SettingActivity extends BaseActivity {
    ...
    private void settingChecked() {
        // 语音播报开关
        announcementsSwitch.setChecked(App.isOpenSound);
        // 活体检测开关
        liveDetectSwitch.setChecked(App.isActionLive);
        // 动作活体随机开关
        actionliveSwitch.setChecked(App.isLivenessRandom);
        ...
        List<LivenessTypeEnum> list = App.livenessList;
        if (list != null) {
...
//    }
    ...
    protected void onDestroy() {
        ...
        App.livenessList = this.livenessList;
        App.isLivenessRandom = actionliveSwitch.isChecked();
        App.isOpenSound = announcementsSwitch.isChecked();
        App.isActionLive = liveDetectSwitch.isChecked();
        setFaceConfig();
    }
