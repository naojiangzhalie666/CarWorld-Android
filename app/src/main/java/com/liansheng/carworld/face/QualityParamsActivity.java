...
import com.liansheng.carworld.face.utils.NumberUtils;
import com.liansheng.carworld.face.widget.AmountView;
import com.liansheng.carworld.face.widget.SelectDialog;
...
public class QualityParamsActivity extends BaseActivity implements View.OnClickListener,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.text_default:  // 点击『恢复默认』
                // 如果参数未改动
                if (!judgeIsModified()) {
                    return;
                } else {
